...
class ControllerTest extends \PHPUnit_Framework_TestCase
{
	...
	public function test_construct() {
		...
		$controller = new \Steampunked\Controller($site, array());
	...
	public function test_actions() {
        ...
        $site = new \Steampunked\Site();
		$steampunked = new \Steampunked\Steampunked(self::SEED);
		$controller = new \Steampunked\Controller($site, array('add', "cap-e.png"));
		...
		$steampunked = new \Steampunked\Steampunked(self::SEED);
		$controller = new \Steampunked\Controller($site, array('rotate', "cap-e.png"));
		...
		$steampunked = new \Steampunked\Steampunked(self::SEED);
		$controller = new \Steampunked\Controller($site, array('discard', "cap-e.png"));
		...
		//test giveUp post
		$steampunked = new \Steampunked\Steampunked(self::SEED);
		$controller = new \Steampunked\Controller($site, array('giveUp'));
